...
# Use SQLAlchemy
engine = create_engine('mysql+pymysql://root:1Bracken12@/birds?unix_socket=/cloudsql/fluted-set-279218:europe-west2:birds', echo=False)
